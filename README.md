...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tensorflow-metadata-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12614&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tensorflow-metadata-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tensorflow-metadata` can be installed with:

```
conda install tensorflow-metadata
```

It is possible to list all of the versions of `tensorflow-metadata` available on your platform with:
